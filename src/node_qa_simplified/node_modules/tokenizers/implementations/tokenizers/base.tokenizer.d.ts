...
import { AddedToken, PaddingConfiguration, PaddingOptions, TokenizedSequence, TokenizedSequenceWithOffsets, Tokenizer, TruncationConfiguration, TruncationOptions } from "../../bindings/tokenizer";
...
export declare class BaseTokenizer<TConfig extends object> {
     ...
     */
    encode(sequence: string, pair?: string, addSpecialTokens?: boolean): Promise<Encoding>;
    /**
     ...
     * @param [addSpecialTokens=true] Whether to add the special tokens while encoding
     */
    encodeBatch(sequences: (string | [string, string])[], addSpecialTokens?: boolean): Promise<Encoding[]>;
    /**
     ...
     * @since 0.6.0
     */
    encodeTokenized(sequence: TokenizedSequence | TokenizedSequenceWithOffsets, typeId?: number): Promise<Encoding>;
    /**
     ...
     * @since 0.6.0
     */
    encodeTokenizedBatch(sequences: (TokenizedSequence | TokenizedSequenceWithOffsets)[], typeId?: number): Promise<Encoding[]>;
    /**
